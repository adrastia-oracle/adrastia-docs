...
| Block time   | Chain monitoring frequency | Base price   | Additional feeds (beyond 10) | Gas price premium |
| ------------ | -------------------------- | ------------ | ---------------------------- | ----------------- |
| 2+ seconds   | 500 milliseconds           | $1,000/month | $50/month per feed           | None              |
| \< 2 seconds | 200 milliseconds           | $1,250/month | $50/month per feed           | None              |
