...
| Block time   | Example chain | Chain monitoring frequency | Price       | Gas price premium |
| ------------ | ------------- | -------------------------- | ----------- | ----------------- |
| 10+ seconds  | Etthereum     | 2 seconds                  | $500/month  | None              |
| 2-10 seconds | Optimism      | 500 milliseconds           | $750/month  | None              |
| \< 2 seconds | Arbitrum One  | 200 milliseconds           | $1000/month | None              |
