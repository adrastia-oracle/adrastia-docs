...
<Callout emoji="🧿">
  [Video: What is an Automated Market Maker? (Liquidity Pool
  Algorithm)](https://www.youtube.com/watch?v=1PbZMudPP5E)
</Callout>
...
After staking tokens, users can deploy updater bots to update our price feeds. Updaters will be paid by our incentives contract when they perform successful updates. Anyone wanting to pay for a price feed can send tokens to our incentives contract.
