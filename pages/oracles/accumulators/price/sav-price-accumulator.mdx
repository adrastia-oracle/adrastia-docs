...
The functionality of the SAV Price Accumulator is identical to the [`PriceAccumulator`](/oracles/accumulators/price) oracle, with the exception that implements `fetchPrice` to track the price of ERC4626 vault share tokens.
